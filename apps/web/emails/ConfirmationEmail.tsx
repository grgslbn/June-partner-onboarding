...
const I18N = {
  fr: {
    ...
    greeting: (firstName: string, partner: string) =>
      `Bonjour ${firstName},\n\nMerci pour votre inscription chez ${partner} × June. Nous vous contacterons au plus vite pour finaliser votre changement de fournisseur d'énergie.`,
    ...
    nextSteps: [
      ...
      '📋  Complétez votre profil énergétique — nous recherchons immédiatement le meilleur tarif.',
  ...
  nl: {
    ...
    greeting: (firstName: string, partner: string) =>
      `Hallo ${firstName},\n\nBedankt voor uw inschrijving bij ${partner} × June. We nemen zo snel mogelijk contact met u op om uw leverancierswissel te finaliseren.`,
    ...
    nextSteps: [
      ...
      '📋  Vul uw energieprofiel aan — we zoeken onmiddellijk het beste tarief voor u.',
  ...
  en: {
    preview: (ref: string, partner: string) =>
      `Confirmation ${ref} — ${partner} × June`,
    greeting: (firstName: string, partner: string) =>
      `Hello ${firstName},\n\nThank you for signing up with ${partner} × June. We'll be in touch as soon as possible to finalise your energy switch.`,
    ...
    nextSteps: [
      ...
      '📋  Complete your energy profile — we immediately search for the best rate for you.',
