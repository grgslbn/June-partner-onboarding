...
5. **Domain.** Staging uses `pos.june-energy.app` (Cloudflare, Resend-verified subdomain). Production domain is still open — likely `onboard.june.energy` but pending confirmation from June.
